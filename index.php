...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to FreeToSpeak</h1>
        <small class="my-content">Learn and Speak</small><br />
        <?php    
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
            <p>FreeToSpeak provides universal access to the world's best skill learning education and organizations to offer coures online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
            <a class="text-dark" href="#">Skill Learning</a><br />
            <a class="text-dark" href="#">English Spoken-1</a><br />
            <a class="text-dark" href="#">English Spoken-2</a><br />
            <a class="text-dark" href="#">English Spoken-3</a><br />
          </div>
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>FreeToSpeak,Varansi <br>Pandeypur-876545 <br> Ph. 9999999 <br>www.freetospeak.com</p>
          </div>
        </div>
      </div>
